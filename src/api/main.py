...
from .schemas import FreightEnriched, FreightListResponse
from .repo import list_freights, get_freight_by_id
...
def freight_by_id(fid: str):
    row = get_freight_by_id(fid)
    if not row:
